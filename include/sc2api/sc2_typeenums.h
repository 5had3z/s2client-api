...
All units and abilities are represented as unsigned numbers in the StarCraft II engine. This can make issue abilities
unnecessarily hard. This file aims to provide a type safe and named way of representing unit types and ability types.
Entries in it are generated by a custom built script so it is possible they don't have every possible id in the engine
but they should have most of the common ones. See stableid.json and stableabilityid.json to see all of them.
*/
...
enum class UNIT_TYPEID {
    ...
    // Terran
    TERRAN_ARMORY = 29,// CANCEL, HALT, CANCEL_LAST, RESEARCH_TERRANSHIPWEAPONS, RESEARCH_TERRANVEHICLEANDSHIPPLATING,
    ...
    TERRAN_BARRACKSTECHLAB =
      37,// RESEARCH_STIMPACK, RESEARCH_COMBATSHIELD, RESEARCH_CONCUSSIVESHELLS, CANCEL, CANCEL_LAST
    ...
    TERRAN_COMMANDCENTER = 18,// SMART, TRAIN_SCV, MORPH_PLANETARYFORTRESS, MORPH_ORBITALCOMMAND, CANCEL, HALT, LOADALL,
    ...
    TERRAN_ENGINEERINGBAY =
      22,// RESEARCH_HISECAUTOTRACKING, RESEARCH_TERRANSTRUCTUREARMORUPGRADE, RESEARCH_NEOSTEELFRAME, CANCEL, HALT,
         // CANCEL_LAST, RESEARCH_TERRANINFANTRYARMOR, RESEARCH_TERRANINFANTRYWEAPONS
    TERRAN_FACTORY = 27,// SMART, TRAIN_SIEGETANK, TRAIN_THOR, TRAIN_HELLION, TRAIN_HELLBAT, TRAIN_CYCLONE,
    ...
    TERRAN_FACTORYTECHLAB = 39,// RESEARCH_INFERNALPREIGNITER, RESEARCH_DRILLINGCLAWS, RESEARCH_RAPIDFIRELAUNCHERS,
                               // RESEARCH_SMARTSERVOS, CANCEL, CANCEL_LAST
    TERRAN_FUSIONCORE = 30,// RESEARCH_BATTLECRUISERWEAPONREFIT, CANCEL, HALT, CANCEL_LAST
    TERRAN_GHOST = 50,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_NUKECALLDOWN, EFFECT_EMP, EFFECT_GHOSTSNIPE, CANCEL,
                      // STOP, ATTACK, BEHAVIOR_CLOAKON, BEHAVIOR_CLOAKOFF, BEHAVIOR_HOLDFIREON, BEHAVIOR_HOLDFIREOFF
    ...
    TERRAN_MEDIVAC = 54,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_HEAL, EFFECT_MEDIVACIGNITEAFTERBURNERS, STOP, LOAD,
                        // UNLOADALLAT, ATTACK
    ...
    TERRAN_ORBITALCOMMAND =
      132,// SMART, EFFECT_CALLDOWNMULE, EFFECT_SUPPLYDROP, EFFECT_SCAN, TRAIN_SCV, CANCEL_LAST, LIFT, RALLY_WORKERS
    ...
    TERRAN_RAVEN = 56,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_POINTDEFENSEDRONE, EFFECT_HUNTERSEEKERMISSILE,
    ...
    TERRAN_SCV = 45,// SMART, MOVE, PATROL, HOLDPOSITION, BUILD_COMMANDCENTER, BUILD_SUPPLYDEPOT, BUILD_REFINERY,
                    // BUILD_BARRACKS, BUILD_ENGINEERINGBAY, BUILD_MISSILETURRET, BUILD_BUNKER, BUILD_SENSORTOWER,
                    // BUILD_GHOSTACADEMY, BUILD_FACTORY, BUILD_STARPORT, BUILD_ARMORY, BUILD_FUSIONCORE, HALT, STOP,
    ...
    TERRAN_STARPORT = 28,// SMART, TRAIN_MEDIVAC, TRAIN_BANSHEE, TRAIN_RAVEN, TRAIN_BATTLECRUISER, TRAIN_VIKINGFIGHTER,
    ...
    TERRAN_STARPORTTECHLAB =
      41,// RESEARCH_BANSHEECLOAKINGFIELD, RESEARCH_RAVENCORVIDREACTOR, RESEARCH_ENHANCEDMUNITIONS,
         // RESEARCH_BANSHEEHYPERFLIGHTROTORS, RESEARCH_RAVENRECALIBRATEDEXPLOSIVES, RESEARCH_HIGHCAPACITYFUELTANKS,
         // RESEARCH_ADVANCEDBALLISTICS, CANCEL, CANCEL_LAST
    ...
    // Zerg
    ZERG_BANELING = 9,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_EXPLODE, BEHAVIOR_BUILDINGATTACKON,
                      // BEHAVIOR_BUILDINGATTACKOFF, BURROWDOWN, STOP, ATTACK
    ...
    ZERG_DRONE =
      104,// SMART, MOVE, PATROL, HOLDPOSITION, BUILD_HATCHERY, BUILD_EXTRACTOR, BUILD_SPAWNINGPOOL,
          // BUILD_EVOLUTIONCHAMBER, BUILD_HYDRALISKDEN, BUILD_SPIRE, BUILD_ULTRALISKCAVERN, BUILD_INFESTATIONPIT,
          // BUILD_NYDUSNETWORK, BUILD_BANELINGNEST, BUILD_ROACHWARREN, BUILD_SPINECRAWLER, BUILD_SPORECRAWLER,
          // BURROWDOWN, STOP, HARVEST_GATHER, HARVEST_RETURN, ATTACK, EFFECT_SPRAY
    ZERG_DRONEBURROWED = 116,// BURROWUP
    ZERG_EGG = 103,// SMART, CANCEL_LAST, RALLY_UNITS
    ZERG_EVOLUTIONCHAMBER =
      90,// CANCEL, CANCEL_LAST, RESEARCH_ZERGGROUNDARMOR, RESEARCH_ZERGMELEEWEAPONS, RESEARCH_ZERGMISSILEWEAPONS
    ZERG_EXTRACTOR = 88,// CANCEL
    ZERG_GREATERSPIRE = 102,// CANCEL_LAST, RESEARCH_ZERGFLYERARMOR, RESEARCH_ZERGFLYERATTACK
    ZERG_HATCHERY = 86,// SMART, MORPH_LAIR, RESEARCH_PNEUMATIZEDCARAPACE, RESEARCH_BURROW, TRAIN_QUEEN, CANCEL,
                       // CANCEL_LAST, RALLY_UNITS, RALLY_WORKERS
    ZERG_HIVE =
      101,// SMART, RESEARCH_PNEUMATIZEDCARAPACE, RESEARCH_BURROW, TRAIN_QUEEN, CANCEL_LAST, RALLY_UNITS, RALLY_WORKERS
    ...
    ZERG_INFESTOR = 111,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_FUNGALGROWTH, EFFECT_INFESTEDTERRANS,
                        // EFFECT_NEURALPARASITE, CANCEL, BURROWDOWN, STOP, ATTACK
    ZERG_INFESTORBURROWED = 127,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_FUNGALGROWTH, EFFECT_INFESTEDTERRANS,
                                // EFFECT_NEURALPARASITE, CANCEL, BURROWUP, STOP, ATTACK
    ZERG_INFESTORTERRAN = 7,// SMART, MOVE, PATROL, HOLDPOSITION, BURROWDOWN, STOP, ATTACK
    ZERG_LAIR = 100,// SMART, MORPH_HIVE, RESEARCH_PNEUMATIZEDCARAPACE, RESEARCH_BURROW, TRAIN_QUEEN, CANCEL,
                    // CANCEL_LAST, RALLY_UNITS, RALLY_WORKERS
    ...
    ZERG_OVERLORD = 106,// SMART, MOVE, PATROL, HOLDPOSITION, MORPH_OVERSEER, BEHAVIOR_GENERATECREEPON,
                        // BEHAVIOR_GENERATECREEPOFF, MORPH_OVERLORDTRANSPORT, CANCEL, STOP, ATTACK
    ZERG_OVERLORDCOCOON = 128,// SMART, MOVE, PATROL, HOLDPOSITION, CANCEL
    ZERG_OVERLORDTRANSPORT = 893,// SMART, MOVE, PATROL, HOLDPOSITION, MORPH_OVERSEER, BEHAVIOR_GENERATECREEPON,
                                 // BEHAVIOR_GENERATECREEPOFF, STOP, LOAD, UNLOADALLAT, ATTACK
    ZERG_OVERSEER = 129,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_SPAWNCHANGELING, EFFECT_CONTAMINATE, STOP, ATTACK
    ZERG_QUEEN = 126,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_INJECTLARVA, EFFECT_TRANSFUSION, BURROWDOWN, STOP,
                     // ATTACK, BUILD_CREEPTUMOR
    ...
    ZERG_VIPER = 499,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_BLINDINGCLOUD, EFFECT_ABDUCT, EFFECT_VIPERCONSUME,
                     // EFFECT_PARASITICBOMB, STOP, ATTACK
    ...
    PROTOSS_CYBERNETICSCORE =
      72,// RESEARCH_WARPGATE, CANCEL, CANCEL_LAST, RESEARCH_PROTOSSAIRARMOR, RESEARCH_PROTOSSAIRWEAPONS
    ...
    PROTOSS_FLEETBEACON =
      64,// RESEARCH_INTERCEPTORGRAVITONCATAPULT, RESEARCH_PHOENIXANIONPULSECRYSTALS, CANCEL, CANCEL_LAST
    PROTOSS_FORGE =
      63,// CANCEL, CANCEL_LAST, RESEARCH_PROTOSSGROUNDARMOR, RESEARCH_PROTOSSGROUNDWEAPONS, RESEARCH_PROTOSSSHIELDS
    PROTOSS_GATEWAY = 62,// SMART, TRAIN_ZEALOT, TRAIN_STALKER, TRAIN_HIGHTEMPLAR, TRAIN_DARKTEMPLAR, TRAIN_SENTRY,
                         // TRAIN_ADEPT, MORPH_WARPGATE, CANCEL, CANCEL_LAST, RALLY_UNITS
    PROTOSS_HIGHTEMPLAR =
      75,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_FEEDBACK, EFFECT_PSISTORM, STOP, RALLY_UNITS, ATTACK
    ...
    PROTOSS_MOTHERSHIP =
      10,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_PHOTONOVERCHARGE, EFFECT_TIMEWARP, STOP, ATTACK, EFFECT_MASSRECALL
    PROTOSS_MOTHERSHIPCORE = 488,// SMART, MOVE, PATROL, HOLDPOSITION, MORPH_MOTHERSHIP, EFFECT_PHOTONOVERCHARGE,
                                 // EFFECT_TIMEWARP, CANCEL, STOP, ATTACK, EFFECT_MASSRECALL
    ...
    PROTOSS_ORACLE = 495,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_ORACLEREVELATION, BEHAVIOR_PULSARBEAMON,
                         // BEHAVIOR_PULSARBEAMOFF, BUILD_STASISTRAP, CANCEL, STOP, ATTACK
    ...
    PROTOSS_PROBE =
      84,// SMART, MOVE, PATROL, HOLDPOSITION, BUILD_NEXUS, BUILD_PYLON, BUILD_ASSIMILATOR, BUILD_GATEWAY, BUILD_FORGE,
         // BUILD_FLEETBEACON, BUILD_TWILIGHTCOUNCIL, BUILD_PHOTONCANNON, BUILD_SHIELDBATTERY, BUILD_STARGATE,
         // BUILD_TEMPLARARCHIVE, BUILD_DARKSHRINE, BUILD_ROBOTICSBAY, BUILD_ROBOTICSFACILITY, BUILD_CYBERNETICSCORE,
         // STOP, HARVEST_GATHER, HARVEST_RETURN, ATTACK, EFFECT_SPRAY
    PROTOSS_PYLON = 60,// CANCEL
    PROTOSS_PYLONOVERCHARGED = 894,// SMART, STOP, ATTACK
    PROTOSS_ROBOTICSBAY =
      70,// RESEARCH_GRAVITICBOOSTER, RESEARCH_GRAVITICDRIVE, RESEARCH_EXTENDEDTHERMALLANCE, CANCEL, CANCEL_LAST
    PROTOSS_ROBOTICSFACILITY = 71,// SMART, TRAIN_WARPPRISM, TRAIN_OBSERVER, TRAIN_COLOSSUS, TRAIN_IMMORTAL,
    ...
    PROTOSS_SENTRY = 77,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_GUARDIANSHIELD, HALLUCINATION_ARCHON,
                        // HALLUCINATION_COLOSSUS, HALLUCINATION_HIGHTEMPLAR, HALLUCINATION_IMMORTAL,
                        // HALLUCINATION_PHOENIX, HALLUCINATION_PROBE, HALLUCINATION_STALKER, HALLUCINATION_VOIDRAY,
                        // HALLUCINATION_WARPPRISM, HALLUCINATION_ZEALOT, EFFECT_FORCEFIELD, HALLUCINATION_ORACLE,
                        // HALLUCINATION_DISRUPTOR, HALLUCINATION_ADEPT, STOP, RALLY_UNITS, ATTACK
    ...
    PROTOSS_TWILIGHTCOUNCIL =
      65,// RESEARCH_CHARGE, RESEARCH_BLINK, RESEARCH_ADEPTRESONATINGGLAIVES, CANCEL, CANCEL_LAST
    PROTOSS_VOIDRAY = 80,// SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_VOIDRAYPRISMATICALIGNMENT, STOP, ATTACK
    PROTOSS_WARPGATE = 133,// SMART, TRAINWARP_ZEALOT, TRAINWARP_STALKER, TRAINWARP_HIGHTEMPLAR, TRAINWARP_DARKTEMPLAR,
                           // TRAINWARP_SENTRY, TRAINWARP_ADEPT, MORPH_GATEWAY
    PROTOSS_WARPPRISM =
      81,// SMART, MOVE, PATROL, HOLDPOSITION, MORPH_WARPPRISMPHASINGMODE, STOP, LOAD, UNLOADALLAT, ATTACK
