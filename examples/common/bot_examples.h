...
class MultiplayerBot : public sc2::Agent
{
  public:
    ...
    size_t CountUnitTypeBuilding(const ObservationInterface *observation,
      UNIT_TYPEID production_building,
      ABILITY_ID ability);

    size_t CountUnitTypeTotal(const ObservationInterface *observation,
...
class ZergMultiplayerBot : public MultiplayerBot
{
  ...
  private:
    std::vector<UNIT_TYPEID> hatchery_types = { UNIT_TYPEID::ZERG_HATCHERY,
...
class TerranMultiplayerBot : public MultiplayerBot
{
  ...
  private:
    ...
    std::vector<UNIT_TYPEID> bio_types = { UNIT_TYPEID::TERRAN_MARINE,
        UNIT_TYPEID::TERRAN_MARAUDER,
        UNIT_TYPEID::TERRAN_GHOST,
        UNIT_TYPEID::TERRAN_REAPER /*reaper*/ };
    std::vector<UNIT_TYPEID> widow_mine_types = { UNIT_TYPEID::TERRAN_WIDOWMINE,
